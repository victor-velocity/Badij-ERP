            ...
            <div className="flex justify-center items-center flex-nowrap gap-7 w-full max-w-[1200px] banner-width p-5">
                ...
                <div className="w-1/2 login-div h-[480px] flex flex-col justify-between">
                    <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <Link href="/login" className="bg-[#153087] hover:bg-[#faf714] hover:text-[black] hover:text-black font-semibold text-white rounded-xl px-8 py-3 transition duration-300 w-full mt-12">
                            Return to Login
                        </Link>
                    </div>
