                                ...
                                <form onSubmit={handleResetPassword} className="mt-7">
                                    ...
                                    <input
                                        ...
                                        className={`border border-solid ${isEmailInvalid ? 'border-red-500' : 'border-[#DDD9D9]'
                                            } p-2 text-sm rounded-lg w-full mt-2 mb-4 pr-10 focus:outline-none focus:ring focus:ring-[#153087] focus:border-[#153087]`}
                                    />

                                    <button
                                        type="submit"
                                        className={`${loading ? "bg-[#153087] cursor-not-allowed" : "bg-[#153087] cursor-pointer hover:bg-[#faf714] hover:text-[black] hover:text-black"} transition-all font-semibold rounded-xl px-4 py-3 w-full mt-8 text-white`}
                                        disabled={loading}
                                    >
